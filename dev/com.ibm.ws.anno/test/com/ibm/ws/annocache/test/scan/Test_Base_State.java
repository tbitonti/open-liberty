...
import com.ibm.ws.annocache.service.internal.AnnotationServiceImpl_Service;
...
public class Test_Base_State {
    ...
    public interface SpecificationFactory {
        ClassSource_Specification createSpecification(
            ClassSource_Factory factory);
    }
    ...
    private ClassSource_Specification classSourceSpecification;
    ...
    public ClassSource_Specification getClassSourceSpecification() {
    ...
    public ClassSourceImpl_Aggregate createClassSource() throws ClassSource_Exception {
        ...
        ClassSource_Specification useSpecification = getClassSourceSpecification();
    ...
    public void setUpFactories() throws Exception {
        targetsService = new AnnotationServiceImpl_Service();
    ...
    protected InfoStoreImpl createInfoStore(ClassSourceImpl_Aggregate classSource)
    ...
    public String getProjectPath() {
        return TestLocalization.getProjectPath();
    }
    ...
    public void displayLocationParameters() {
        ...
        String projectPath = TestLocalization.getProjectPath();
