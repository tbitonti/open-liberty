...
public class SCITest_SCIAbsoluteNoOthers_war_Test extends Test_Base {
    ...
    public static final String WAR_SIMPLE_NAME = SCITest_Data.WAR_SIMPLE_NAME_ABSOLUTE_NO_OTHERS;    
    ...
    @Test
    public void testSCI_SCIAbsoluteNoOthers() throws Exception {
        runSuiteTest( getBaseCase() ); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSCI_SCIAbsoluteNoOthers_SINGLE_JANDEX() throws Exception {
    ...
    @Test
    public void testSCI_SCIAbsoluteNoOthers_SINGLE_WRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_WRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSCI_SCIAbsoluteNoOthers_SINGLE_READ() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_READ); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSCI_SCIAbsoluteNoOthers_MULTI_WRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.MULTI_WRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSCI_SCIAbsoluteNoOthers_MULTI_READ() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.MULTI_READ); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSCI_SCIAbsoluteNoOthers_SINGLE_WRITE_ASYNC() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_WRITE_ASYNC); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSCI_SCIAbsoluteNoOthers_MULTI_WRITE_ASYNC() throws Exception {
