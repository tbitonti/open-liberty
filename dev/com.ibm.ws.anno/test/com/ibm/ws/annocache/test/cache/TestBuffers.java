...
public class TestBuffers {
    public static File prepareStrings(String fileName) {
        ...
        Assert.assertFalse("Test file [ " + fileName + " ] does exists", testFile.exists());
    ...
    public static class TestProfile {
        ...
        public static final String TEST_FILE_NAME = "buffer.test";
    ...
    public static final String STRINGS_FILE_NAME = "buffer.strings";
