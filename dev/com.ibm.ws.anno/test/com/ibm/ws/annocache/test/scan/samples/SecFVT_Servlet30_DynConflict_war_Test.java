...
public class SecFVT_Servlet30_DynConflict_war_Test extends Test_Base {
    ...
    public ClassSource_Specification_Direct_WAR createClassSourceSpecification(ClassSource_Factory factory) {
        return SecFVT_Servlet30_Data.createClassSourceSpecification_WAR(
            factory,
            SecFVT_Servlet30_Data.WAR_DYNCONFLICT_SIMPLE_NAME,
            SecFVT_Servlet30_Data.WAR_DYNCONFLICT_NAME);
    }
    ...
    public String getModName() {
        return SecFVT_Servlet30_Data.WAR_DYNCONFLICT_NAME;
    }

    @Override
    public String getModSimpleName() {
        return SecFVT_Servlet30_Data.WAR_DYNCONFLICT_SIMPLE_NAME;
    }

    //

    @Test
    public void testSecFVT_Servlet30_DynConflict_war_BASE() throws Exception {
        runSuiteTest( getBaseCase() ); // 'runSuiteTest' throws Exception
    }
    

    @Test
    public void testSecFVT_Servlet30_DynConflict_SINGLE_JANDEX() throws Exception {
    ...
    @Test
    public void testSecFVT_Servlet30_DynConflict_SINGLE_WRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_WRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSecFVT_Servlet30_DynConflict_SINGLE_READ() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_READ); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSecFVT_Servlet30_DynConflict_MULTI_WRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.MULTI_WRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSecFVT_Servlet30_DynConflict_MULTI_READ() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.MULTI_READ); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSecFVT_Servlet30_DynConflict_SINGLE_WRITE_ASYNC() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_WRITE_ASYNC); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testSecFVT_Servlet30_DynConflict_MULTI_WRITE_ASYNC() throws Exception {
