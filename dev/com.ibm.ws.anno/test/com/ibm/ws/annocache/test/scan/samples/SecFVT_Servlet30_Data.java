...
public class SecFVT_Servlet30_Data {
    ...
    public static ClassSource_Specification_Direct_WAR createClassSourceSpecification_WAR(
    ...
    public static ClassSource_Specification_Direct_EJB createClassSourceSpecification_EJBJar(
    	ClassSource_Factory classSourceFactory) {
