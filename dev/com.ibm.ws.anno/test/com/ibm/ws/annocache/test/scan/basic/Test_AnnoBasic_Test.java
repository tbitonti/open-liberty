...
public class Test_AnnoBasic_Test extends Test_Base {
    ...
    @Override
    public ClassSource_Specification_Direct_EJB createClassSourceSpecification(ClassSource_Factory classSourceFactory) {
    ...
    public void testOverrideWithAnnotation() {
        ...
        Set<String> resourceTargetNames = getBaseTargets().getClassesWithMethodAnnotation(resourceAnnoName);
    ...
    public void testFieldAnnotations() {
        ...
        Set<String> idTargetNames = getBaseTargets().getClassesWithFieldAnnotation(idAnnoName);
    ...
    public void testNoInheritAnnos() {
        ...
        Set<String> resourceTargetNames = getBaseTargets().getAllInheritedAnnotatedClasses(resourceAnnoName);
