...
public class DT7_DT_war_Test extends Test_Base {
    ...
    @Test
    public void testDT7_DT_war_SINGLE_WRITE_JANDEX_NOWRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_WRITE_JANDEX_NOWRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testDT7_DT_war_SINGLE_READ_JANDEX_NOWRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_READ_JANDEX_NOWRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testDT7_DT_war_MULTI_WRITE_JANDEX_NOWRITE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.MULTI_WRITE_JANDEX_NOWRITE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testDT7_DT_war_MULTI_READ_JANDEX_NOWRITE() throws Exception {
    ...
    @Test
    public void testDT7_DT_war_SINGLE_WRITE_SEPARATE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_WRITE_SEPARATE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testDT7_DT_war_SINGLE_READ_SEPARATE() throws Exception {
        runSuiteTest(TestOptions_SuiteCase.SINGLE_READ_SEPARATE); // 'runSuiteTest' throws Exception
    }

    @Test
    public void testDT7_DT_war_MULTI_WRITE_SEPARATE() throws Exception {
