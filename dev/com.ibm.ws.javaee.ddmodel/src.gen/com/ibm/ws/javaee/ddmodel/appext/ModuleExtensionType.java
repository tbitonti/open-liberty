...
public class ModuleExtensionType extends com.ibm.ws.javaee.ddmodel.DDParser.ElementContentParsable implements com.ibm.ws.javaee.dd.appext.ModuleExtension {
    ...
    public boolean handleChild(DDParser parser, String localName) throws DDParser.ParseException {
        if (xmi && "module".equals(localName)) {
            this.module = new com.ibm.ws.javaee.ddmodel.CrossComponentReferenceType("module", parser.primaryDescriptorType);
            parser.parse(module);
        ...
        if (xmi && "applicationExtension".equals(localName)) {
            this.applicationExtension = new com.ibm.ws.javaee.ddmodel.CrossComponentReferenceType("applicationExtension", parser.primaryDescriptorType);
