...
public class SharedServer extends ExternalResource {
    ...
    public void before() throws Exception {
        ...
        liberty = LibertyServerFactory.getLibertyServer("dynacachetests", null, true);
        ...
        if (wab != null) {
            ...
            if (!testName.equals("DiskContents"))
                Assert.assertNotNull("CWWKO0219I.*ssl not recieved", liberty.waitForStringInLog("CWWKO0219I.*ssl"));
    ...
    public boolean isServerUp() {
        if (null != liberty && liberty.isStarted()) {
            return liberty.waitForStringInLog("CWWKO0219I.*ssl") != null;
        } else {
            return false;
        }
    }
