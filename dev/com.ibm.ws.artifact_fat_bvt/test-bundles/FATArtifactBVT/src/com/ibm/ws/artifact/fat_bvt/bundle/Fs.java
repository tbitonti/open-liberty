...
public class Fs {
    ...
    public static Fs Dir(
        String name, String path,
        String resource, String physicalPath,
        int uriCount, String[] uris,
        Fs... children) {

        return new Fs( FsType.DIR,
                       name, path,
                       null, null,
    ...
    public static Fs File(
        String name, String path,
        boolean hasData, String data, long size,
        String resource, String physicalPath) {

        return new Fs( FsType.FILE,
                       name, path,
                       null, null,
                       resource, physicalPath,
                       -1, null,
    ...
    public Fs getChildByName(String targetChildName) {
        if ( children == null ) {
            return null;
        }

        for ( Fs nextChild : children ) {
