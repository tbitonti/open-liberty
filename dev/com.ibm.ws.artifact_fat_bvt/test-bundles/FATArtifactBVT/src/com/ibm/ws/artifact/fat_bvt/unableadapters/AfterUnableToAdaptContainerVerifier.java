 ...
 */
package com.ibm.ws.artifact.fat_bvt.unableadapters;
 ...
 *
 */
public class AfterUnableToAdaptContainerVerifier implements ContainerAdapter<Float> {
    ...
    public Float adapt(Container root, OverlayContainer rootOverlay, ArtifactContainer artifactContainer, Container containerToAdapt) throws UnableToAdaptException {
        ...
        if (name.equals("aa") || name.equals("ab") || name.equals("bb")) {
            //if any of these reach us.. flag with the special return.
