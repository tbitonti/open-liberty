...
/**
 * Zip caching utilities.
 *
 * This utility class provides static utility methods for debugging.
 *
 * This utility provides three sets of java custom properties which
 * provide configuration options to the zip caching service.
 *
 ...
 * layer:
 *
 * zip.cache.handle.max       -1 | (>0)      [ 511 ]
 * zip.cache.entry.limit       0 | (>0)      [ 0 ]
...
public class ZipCacheUtils {
    ...
    public static final int ZIP_CACHE_HANDLE_MAX_DEFAULT_VALUE = 511; // 255;
    ...
    public static final int ZIP_CACHE_ENTRY_LIMIT_DEFAULT_VALUE = 0; // 8192;
    ...
    public static final long ZIP_CACHE_REAPER_SHORT_INTERVAL_DEFAULT_VALUE =
        ZipCacheUtils.ONE_SEC_IN_NANO_SEC / 10;
    ...
    public static final long ZIP_CACHE_REAPER_LONG_INTERVAL_DEFAULT_VALUE =
        ZipCacheUtils.ONE_SEC_IN_NANO_SEC / 5;
