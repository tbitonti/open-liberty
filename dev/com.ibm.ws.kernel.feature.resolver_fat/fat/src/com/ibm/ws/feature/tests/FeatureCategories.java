...
import static com.ibm.ws.feature.tests.FeatureNameCache.VERSION_COMPARATOR;
import static com.ibm.ws.feature.tests.FeatureNameCache.isAnomalous;
import static com.ibm.ws.feature.tests.FeatureUtil.getVersionLink;
import static com.ibm.ws.feature.tests.FeatureUtil.isAuto;
import static com.ibm.ws.feature.tests.FeatureUtil.isCompatibility;
import static com.ibm.ws.feature.tests.FeatureUtil.isConvenience;
import static com.ibm.ws.feature.tests.FeatureUtil.isPrivate;
import static com.ibm.ws.feature.tests.FeatureUtil.isPublic;
import static com.ibm.ws.feature.tests.FeatureUtil.isVersionless;
...
public class FeatureCategories {
    ...
    public FeatureCategories(Collection<? extends ProvisioningFeatureDefinition> featureDefs) {
        for (ProvisioningFeatureDefinition featureDef : featureDefs) {
            ...
            List<String> akaNames = featureDef.getAltNames();
            if ( akaNames.size() == 1 ) {
