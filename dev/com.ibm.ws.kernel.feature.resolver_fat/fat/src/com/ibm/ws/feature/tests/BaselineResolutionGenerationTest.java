...
public class BaselineResolutionGenerationTest {
    ...
    public static final boolean RUN_SINGLETON = BaselineResolutionEnablement.enableSingletonGeneration;
    public static final boolean RUN_SERVLET = BaselineResolutionEnablement.enableServletGeneration;
    ...
    public static void setupBaseXML() throws Exception {
        ...
        repoPath_OL = repoFile_OL.getCanonicalPath();
        ...
        singletonDurationsPath_OL = singletonDurationsFile_OL.getCanonicalPath();
        ...
        singletonActualResultsPath_OL = singletonActualResultsFile_OL.getCanonicalPath();
        ...
        servletDurationsPath_OL = servletDurationsFile_OL.getCanonicalPath();
        ...
        servletActualResultsPath_OL = servletActualResultsFile_OL.getCanonicalPath();
    ...
    public static void completeXML() throws Exception {
        ...
        repoPath = repoFile.getCanonicalPath();
        ...
        if (RUN_SINGLETON) {
            ...
            singletonActualResultsPath = singletonActualResultsFile.getCanonicalPath();
            ...
            singletonDurationsPath = singletonDurationsFile.getCanonicalPath();
            ...
            singletonExpectedResultsPath_OL = singletonExpectedResultsFile_OL.getCanonicalPath();
            ...
            if (isWASLiberty) {
                ...
                singletonExpectedResultsPath_WL = singletonExpectedResultsFile_WL.getCanonicalPath();
        ...
        if (RUN_SERVLET) {
            ...
            servletActualResultsPath = servletActualResultsFile.getCanonicalPath();
            ...
            servletDurationsPath = servletDurationsFile.getCanonicalPath();
            ...
            servletExpectedResultsPath_OL = servletExpectedResultsFile_OL.getCanonicalPath();
            ...
            if (isWASLiberty) {
                ...
                servletExpectedResultsPath_WL = servletExpectedResultsFile_WL.getCanonicalPath();
    ...
    @Test
    public void baseline_verifyResolutionTest() throws Exception {
    ...
    protected static VerifyData load(String tag, String path) throws Exception {
        ...
        if (!file.exists()) {
            Assert.fail(tag + ": [ " + file.getCanonicalPath() + " ]: does not exist");
            return null;
        } else {
