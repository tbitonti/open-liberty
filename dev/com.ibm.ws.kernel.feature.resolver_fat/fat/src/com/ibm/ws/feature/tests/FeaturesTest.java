...
import com.ibm.ws.kernel.feature.internal.util.FeatureXML;
...
public class FeaturesTest {
    ...
    protected static File setupOutput(String tag, String outputPath) {
        File outputFile = new File(outputPath);
        String absOutputPath = outputFile.getAbsolutePath();

        File outputParent = outputFile.getParentFile();
        String absOutputParentPath = outputParent.getAbsolutePath();
    ...
    @Test
    public void testReportText() throws Exception {
